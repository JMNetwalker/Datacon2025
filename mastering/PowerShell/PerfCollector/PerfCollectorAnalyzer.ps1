...
param($Folder = "C:\MyDocs\PerfChecker", #Folder Parameter to open the files gathered from PerfCollector tool  
      $server = "servername", #ServerName parameter to connect,for example, myserver.database.windows.net
      $user = "username", #UserName parameter  to connect
      $Db = "QDS", #Name of the database that this script will save the data imported - Please use a new empty database
      $passwordSecure = "pwd") #Password to connect to the database.
